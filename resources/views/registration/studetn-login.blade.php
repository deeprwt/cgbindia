    ...
    <div class="page-wrapper   p-b-50">
        ...
        <div class="wrapper wrapper--w790 p-2">
            ...
            <div class="card card-5">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('stundet.login') }}">
                        @csrf
                      <div class="row my-3">
                          <div class="col-md-12">
                              <label class="label label--block">Email / Phone</label>
                            <input class="input--style-5  form-control border-0"  placeholder="Email / Phone" type="text" name="email" required>
                          </div>
                      ...
                      <div class="row my-3">
                        <div class="col-md-12">
                          ...
                          <input class="input--style-5  form-control border-0" 
                           placeholder="enter password" type="password" name="password" required>
                        </div>
                        
                    </div>
                    <div class="my-3 text-right">
                        <a href="https://iam.eupheusapp.com/" class="nav-link text-danger">forgot password ?</a>
                    </div>
