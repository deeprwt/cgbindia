...
<div id="particle-container">
    ...
    @include('flash_message.flash_message')
            <div class="card card-5">
                ...
                <div class="card-body">
                    <form  action="{{ url('verifyStudentPhone') }}" method="POST">
                        @csrf
                      <div class="row my-3">
                          <div class="col-md-12">
                              <label class="label label--block">Phone</label>
                            <input class="input--style-5  form-control border-0"  placeholder="enter registred phone" type="text" required name="email" >
                          </div>
