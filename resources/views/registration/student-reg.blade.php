    ...
    <div class="page-wrapper   p-b-50">
        ...
        <div class="wrapper wrapper--w790 p-2">
            ...
            <div class="card card-5">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('stundet.checkCode') }}">
                        @csrf
                      <div class="row my-3">
                          <div class="col-md-12">
                              <label class="label label--block">Enter School Code</label>
                            <input class="input--style-5  form-control border-0"  placeholder="enter school code" type="text" name="code" required>
                          </div>
                        ...
                        <div class="text-right">
                            <button class="btn btn--radius-2 btn--red" type="submit">Enter</button>
                        </div>
                    </form>
                </div>
            </div>
